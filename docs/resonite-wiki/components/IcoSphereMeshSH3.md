# Component:IcoSphereMeshSH3

> Source: https://wiki.resonite.com/Component:IcoSphereMeshSH3

Collapse **Component image**

[File:IcoSphereMeshSH3Component.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=IcoSphereMeshSH3Component.png "File:IcoSphereMeshSH3Component.png") **Ico Sphere Mesh SH3** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **Ico Sphere Mesh SH3** component creates Ico Sphere data using Sphercal harmonics.
...
| `Colors` | **[SphericalHarmonicsL3\`1](https://wiki.resonite.com/Type:SphericalHarmonicsL3%601 "Type:SphericalHarmonicsL3`1") < [ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX") >** | The spherical harmonic colors to use. |
| `RadiusMultiplier` | **[SphericalHarmonicsL3\`1](https://wiki.resonite.com/Type:SphericalHarmonicsL3%601 "Type:SphericalHarmonicsL3`1") < [Float](https://wiki.resonite.com/Type:Float "Type:Float") >** | The spherical harmonics to use to influence the mesh radius at different spots. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:IcoSphereMeshSH3&oldid=98456](https://wiki.resonite.com/index.php?title=Component:IcoSphereMeshSH3&oldid=98456)"
