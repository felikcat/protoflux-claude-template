# Component:UI TextUnlitMaterial

> Source: https://wiki.resonite.com/Component:UI_TextUnlitMaterial

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/9/99/UI_TextUnlitMaterialComponent.png/510px-UI_TextUnlitMaterialComponent.png)](https://wiki.resonite.com/File:UI_TextUnlitMaterialComponent.png) **UI Text Unlit Material** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **UI\_TextUnlitMaterial** component is a material used to render text glyphs on a [UIX](https://wiki.resonite.com/UIX "UIX"). It does so via meshes that automatically generates UV maps that map to each character on a font map. Such as [Component:Text](https://wiki.resonite.com/Component:Text "Component:Text") and [Component:TextRenderer](https://wiki.resonite.com/Component:TextRenderer "Component:TextRenderer").
...
| `OffsetFactor` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer, based on the polygon's slope relative to the camera (i.e. polygons parallel to the camera will not be affected by this).[\[1\]](https://wiki.resonite.com/Component:UI_TextUnlitMaterial#cite_note-Material_OffsetFactor/Units_Desc-1) |
| `OffsetUnits` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer (regardless of the polygon's slope relative to the camera), in units equal to the smallest possible difference for the rendering device being used.[\[1\]](https://wiki.resonite.com/Component:UI_TextUnlitMaterial#cite_note-Material_OffsetFactor/Units_Desc-1) |
...
- [Component:TextUnlitMaterial](https://wiki.resonite.com/Component:TextUnlitMaterial "Component:TextUnlitMaterial")
- [Component:Text](https://wiki.resonite.com/Component:Text "Component:Text")

1. ↑ [Jump up to: 1.0](https://wiki.resonite.com/Component:UI_TextUnlitMaterial#cite_ref-Material_OffsetFactor/Units_Desc_1-0)[1.1](https://wiki.resonite.com/Component:UI_TextUnlitMaterial#cite_ref-Material_OffsetFactor/Units_Desc_1-1)[https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html](https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html)

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:UI\_TextUnlitMaterial&oldid=105876](https://wiki.resonite.com/index.php?title=Component:UI_TextUnlitMaterial&oldid=105876)"
