# Component:ThresholdMaterial

> Source: https://wiki.resonite.com/Component:ThresholdMaterial

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:ThresholdMaterial&diff=105874) which are not marked for translation.

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/0/0f/ThresholdMaterialComponent.png/510px-ThresholdMaterialComponent.png)](https://wiki.resonite.com/File:ThresholdMaterialComponent.png) **Threshold Material** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Threshold` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much brightness is needed to pass the filter. |
| `Transition` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much of the color to transition across at the threshold limit. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:ThresholdMaterial&oldid=105874](https://wiki.resonite.com/index.php?title=Component:ThresholdMaterial&oldid=105874)"
