# Component:FeedClampedValueFieldInterface

> Source: https://wiki.resonite.com/Component:FeedClampedValueFieldInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/a/a4/FeedClampedValueFieldInterface%601Component.png/510px-FeedClampedValueFieldInterface%601Component.png)](https://wiki.resonite.com/File:FeedClampedValueFieldInterface%601Component.png) **Feed Clamped Value Field Interface\`1** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedClampedValueFieldInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system. This component allows for making a UI Template for changing a value with a minimum and maximum value.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedClampedValueFieldInterface&oldid=97490](https://wiki.resonite.com/index.php?title=Component:FeedClampedValueFieldInterface&oldid=97490)"
