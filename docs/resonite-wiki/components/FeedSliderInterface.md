# Component:FeedSliderInterface

> Source: https://wiki.resonite.com/Component:FeedSliderInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/c/c1/FeedSliderInterface%601Component.png/510px-FeedSliderInterface%601Component.png)](https://wiki.resonite.com/File:FeedSliderInterface%601Component.png) **Feed Slider Interface\`1** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedSliderInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system. This component in particular is used to make sliders for stuff like volume or motion blur.
...
| `Value` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") <T>** | The field that represents the data that should be read from and written to the source data feed. |
| `Formatting` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [String](https://wiki.resonite.com/Type:String "Type:String") >** | The field to fill with data on how to format the value for displaying it. |
| `Min` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") <T>** | The value Field to fill with the minimum value this feed number can be. |
| `Max` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") <T>** | The value Field to fill with the maximum value this feed number can be. |
| `ReferenceValue` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") <T>** | The default reference value field for this slider (ex: this is a value that the slider should have by default) |
| `ReferenceValueCleanupRoot` | **[Slot](https://wiki.resonite.com/Type:Slot "Type:Slot")** | The slot to delete if a reference value is not needed. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedSliderInterface&oldid=97499](https://wiki.resonite.com/index.php?title=Component:FeedSliderInterface&oldid=97499)"
