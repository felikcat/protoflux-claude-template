...
> Source: https://wiki.resonite.com/Component:PixelateMaterial

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:PixelateMaterial&diff=105866) which are not marked for translation.

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/5/56/PixelateMaterialComponent.png/510px-PixelateMaterialComponent.png)](https://wiki.resonite.com/File:PixelateMaterialComponent.png) **Pixelate Material** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Resolution` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | The resolution of the pixel effect. |
| `ResolutionMagnitudeTexture` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | The texture to determine the resolution of certain areas of the surface. |
| `ResolutionTextureScale` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | How big to scale the `ResolutionMagnitudeTexture` along the surface. |
| `ResolutionTextureOffset` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | How much to offset the `ResolutionMagnitudeTexture` along the surface. |
...
Attach to a slot and then insert into a [SkinnedMeshRenderer](https://wiki.resonite.com/Component:SkinnedMeshRenderer "Component:SkinnedMeshRenderer") or [MeshRenderer](https://wiki.resonite.com/Component:MeshRenderer "Component:MeshRenderer") with a mesh to view it.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:PixelateMaterial&oldid=105866](https://wiki.resonite.com/index.php?title=Component:PixelateMaterial&oldid=105866)"
