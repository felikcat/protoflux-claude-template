# Component:RibbonWidthConstantInitializer

> Source: https://wiki.resonite.com/Component:RibbonWidthConstantInitializer

Collapse **Component image**

[File:RibbonWidthConstantInitializerComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=RibbonWidthConstantInitializerComponent.png "File:RibbonWidthConstantInitializerComponent.png") **Ribbon Width Constant Initializer** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **RibbonWidthConstantInitializer** component makes all ribbons in a particle system have a starting width of `Value`.
...
| `Value` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | The starting width all ribbons in the particle system should have. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:RibbonWidthConstantInitializer&oldid=96060](https://wiki.resonite.com/index.php?title=Component:RibbonWidthConstantInitializer&oldid=96060)"
