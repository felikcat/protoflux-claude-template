# Component:PBS VertexColorMetallic

> Source: https://wiki.resonite.com/Component:PBS_VertexColorMetallic

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:PBS_VertexColorMetallic&diff=106299) which are not marked for translation.

_This article or section is a stub. You can help the Resonite wiki by expanding it._

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/1/19/PBS_VertexColorMetallicComponent.png/510px-PBS_VertexColorMetallicComponent.png)](https://wiki.resonite.com/File:PBS_VertexColorMetallicComponent.png) **PBS Vertex Color Metallic** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **PBS\_VertexColorMetallic** component is a [Component:PBS\_Metallic](https://wiki.resonite.com/Component:PBS_Metallic "Component:PBS Metallic") component except that it allows for the use of vertex colors as a multiplier for different colors/properties of the material.
...
| `OffsetFactor` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer, based on the polygon's slope relative to the camera (i.e. polygons parallel to the camera will not be affected by this).[\[1\]](https://wiki.resonite.com/Component:PBS_VertexColorMetallic#cite_note-Material_OffsetFactor/Units_Desc-1) |
| `OffsetUnits` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer (regardless of the polygon's slope relative to the camera), in units equal to the smallest possible difference for the rendering device being used.[\[1\]](https://wiki.resonite.com/Component:PBS_VertexColorMetallic#cite_note-Material_OffsetFactor/Units_Desc-1) |
...
| `VertexColorTarget` | **[ColorTarget](https://wiki.resonite.com/Component:PBS_VertexColorMetallic#ColorTarget)** | The material map type that vertex colors should be applied to. |
...
| `Metallic` | 2 | Vertex colors should be applied as a multiplier to the material's metallic/smoothness look. |
...
1. ↑ [Jump up to: 1.0](https://wiki.resonite.com/Component:PBS_VertexColorMetallic#cite_ref-Material_OffsetFactor/Units_Desc_1-0)[1.1](https://wiki.resonite.com/Component:PBS_VertexColorMetallic#cite_ref-Material_OffsetFactor/Units_Desc_1-1)[https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html](https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html)

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:PBS\_VertexColorMetallic&oldid=106299](https://wiki.resonite.com/index.php?title=Component:PBS_VertexColorMetallic&oldid=106299)"
