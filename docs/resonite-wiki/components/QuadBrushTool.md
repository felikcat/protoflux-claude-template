# Component:QuadBrushTool

> Source: https://wiki.resonite.com/Component:QuadBrushTool

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/b/b4/QuadBrushToolComponent.png/510px-QuadBrushToolComponent.png)](https://wiki.resonite.com/File:QuadBrushToolComponent.png) **Quad Brush Tool** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Pivot` | **[Float3](https://wiki.resonite.com/Type:Float3 "Type:Float3")** | the position offset for the rotation Pivot for quads. |
| `DualSided` | **[Bool](https://wiki.resonite.com/Type:Bool "Type:Bool")** | Whether the drawn quads are dual sided. |
| `MinRotation` | **[Float3](https://wiki.resonite.com/Type:Float3 "Type:Float3")** | the minimum rotation of a drawn quad. |
| `MaxRotation` | **[Float3](https://wiki.resonite.com/Type:Float3 "Type:Float3")** | the maximum rotation of a drawn quad |
| `RotationSpace` | _direct_ **[RootSpace](https://wiki.resonite.com/Type:RootSpace "Type:RootSpace")** | The transform space to apply rotations on drawn Quads in. |
...
| `_previewMesh` | _[reference drive](https://wiki.resonite.com/Type:DriveRef%601 "Type:DriveRef`1")_ of **[QuadArrayMesh](https://wiki.resonite.com/Component:QuadArrayMesh "Component:QuadArrayMesh")** | The mesh being used to preview the stroke of this brush. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:QuadBrushTool&oldid=98394](https://wiki.resonite.com/index.php?title=Component:QuadBrushTool&oldid=98394)"
