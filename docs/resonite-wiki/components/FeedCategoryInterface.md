# Component:FeedCategoryInterface

> Source: https://wiki.resonite.com/Component:FeedCategoryInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/1/11/FeedCategoryInterfaceComponent.png/510px-FeedCategoryInterfaceComponent.png)](https://wiki.resonite.com/File:FeedCategoryInterfaceComponent.png) **Feed Category Interface** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedCategoryInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system.
...
| `Path` | **[SyncFieldList\`1](https://wiki.resonite.com/Type:SyncFieldList%601 "Type:SyncFieldList`1") < [String](https://wiki.resonite.com/Type:String "Type:String") >** | A list of strings specifying this categories specific sub path. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedCategoryInterface&oldid=97489](https://wiki.resonite.com/index.php?title=Component:FeedCategoryInterface&oldid=97489)"
