...
> Source: https://wiki.resonite.com/Component:DesktopScreen

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/7/7a/DesktopScreenComponent.png/510px-DesktopScreenComponent.png)](https://wiki.resonite.com/File:DesktopScreenComponent.png) **Desktop Screen** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **DesktopScreen** component is used to make the behavior of the desktop tab on the [Dash Menu](https://wiki.resonite.com/Dash_Menu "Dash Menu").
...
| `_screenRoot` | **[Slot](https://wiki.resonite.com/Type:Slot "Type:Slot")** | The root slot of the desktop screen view. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:DesktopScreen&oldid=96470](https://wiki.resonite.com/index.php?title=Component:DesktopScreen&oldid=96470)"
