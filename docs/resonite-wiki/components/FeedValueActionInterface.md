# Component:FeedValueActionInterface

> Source: https://wiki.resonite.com/Component:FeedValueActionInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/6/61/FeedValueActionInterface%601Component.png/510px-FeedValueActionInterface%601Component.png)](https://wiki.resonite.com/File:FeedValueActionInterface%601Component.png) **Feed Value Action Interface\`1** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedValueActionInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system. This component specifically passes a value to an action that requires a value argument to be passed.
...
| `Action` | **[SyncDelegate\`1](https://wiki.resonite.com/Type:SyncDelegate%601 "Type:SyncDelegate`1") < [Action\`1](https://wiki.resonite.com/Type:Action%601 "Type:Action`1") <T>>** | The field to fill with the Action to be triggered. |
| `Value` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") <T>** | The field to fill with the value that should be passed. |
| `Highlight` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Bool](https://wiki.resonite.com/Type:Bool "Type:Bool") >** | Whether this item should be highlighted or is being highlighted. |
...
The `Action` and `Value` fields can be used to fill a [CallbackValueArgument](https://wiki.resonite.com/Component:CallbackValueArgument "Component:CallbackValueArgument") which can be triggered via a button.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedValueActionInterface&oldid=98401](https://wiki.resonite.com/index.php?title=Component:FeedValueActionInterface&oldid=98401)"
