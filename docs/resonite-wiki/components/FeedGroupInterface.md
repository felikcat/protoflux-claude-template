# Component:FeedGroupInterface

> Source: https://wiki.resonite.com/Component:FeedGroupInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/3/39/FeedGroupInterfaceComponent.png/510px-FeedGroupInterfaceComponent.png)](https://wiki.resonite.com/File:FeedGroupInterfaceComponent.png) **Feed Group Interface** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedGroupInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedGroupInterface&oldid=97493](https://wiki.resonite.com/index.php?title=Component:FeedGroupInterface&oldid=97493)"
