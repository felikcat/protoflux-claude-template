# Component:PBS RimSpecular

> Source: https://wiki.resonite.com/Component:PBS_RimSpecular

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:PBS_RimSpecular&diff=105953) which are not marked for translation.

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/5/56/PBS_RimSpecularComponent.png/510px-PBS_RimSpecularComponent.png)](https://wiki.resonite.com/File:PBS_RimSpecularComponent.png) **PBS Rim Specular** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **PBS\_RimSpecular** material is used in away materials, and can be used to make a normal PBS material with an emissive rim from camera view.
...
| `OffsetFactor` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer, based on the polygon's slope relative to the camera (i.e. polygons parallel to the camera will not be affected by this).[\[1\]](https://wiki.resonite.com/Component:PBS_RimSpecular#cite_note-Material_OffsetFactor/Units_Desc-1) |
| `OffsetUnits` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer (regardless of the polygon's slope relative to the camera), in units equal to the smallest possible difference for the rendering device being used.[\[1\]](https://wiki.resonite.com/Component:PBS_RimSpecular#cite_note-Material_OffsetFactor/Units_Desc-1) |
...
1. ↑ [Jump up to: 1.0](https://wiki.resonite.com/Component:PBS_RimSpecular#cite_ref-Material_OffsetFactor/Units_Desc_1-0)[1.1](https://wiki.resonite.com/Component:PBS_RimSpecular#cite_ref-Material_OffsetFactor/Units_Desc_1-1)[https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html](https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html)

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:PBS\_RimSpecular&oldid=105953](https://wiki.resonite.com/index.php?title=Component:PBS_RimSpecular&oldid=105953)"
