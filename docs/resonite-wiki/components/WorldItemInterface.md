...
> Source: https://wiki.resonite.com/Component:WorldItemInterface

Collapse **Component image**

[File:WorldItemInterfaceComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=WorldItemInterfaceComponent.png "File:WorldItemInterfaceComponent.png") **World Item Interface** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **WorldItemInterface** component is used with [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") to show information about a particular world mapped to it. This is used in the worlds menu.
...
| `WorldName` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [String](https://wiki.resonite.com/Type:String "Type:String") >** | The name of the world mapped to this template. |
| `Description` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [String](https://wiki.resonite.com/Type:String "Type:String") >** | The description of the world mapped to this template. |
| `ThumbnailUrl` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Uri](https://wiki.resonite.com/Type:Uri "Type:Uri") >** | The URL of the preview world texture for the world mapped to this template. |
| `JoinedUsers` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Int](https://wiki.resonite.com/Type:Int "Type:Int") >** | The amount of users currently in the world mapped to this template. |
| `ActiveUsers` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Int](https://wiki.resonite.com/Type:Int "Type:Int") >** | The amount of focused active users in the world mapped to this template. |
| `IsHost` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Bool](https://wiki.resonite.com/Type:Bool "Type:Bool") >** | Whether the local user is the host of the world mapped to this template. |
| `AwayKickEnabled` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Bool](https://wiki.resonite.com/Type:Bool "Type:Bool") >** | Whether away kick is enabled for this world. |
| `AwayKickInterval` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [TimeSpan](https://wiki.resonite.com/Type:TimeSpan "Type:TimeSpan") >** | The interval at which after this amount of time, users should be kicked. |
...
Used in the world browser menu with the [Component:WorldsDataFeed](https://wiki.resonite.com/Component:WorldsDataFeed "Component:WorldsDataFeed")

## See Also

- [Component:WorldsDataFeed](https://wiki.resonite.com/Component:WorldsDataFeed "Component:WorldsDataFeed")

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:WorldItemInterface&oldid=100828](https://wiki.resonite.com/index.php?title=Component:WorldItemInterface&oldid=100828)"
