# Component:FeedValueFieldInterface

> Source: https://wiki.resonite.com/Component:FeedValueFieldInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/e/e7/FeedValueFieldInterface%601Component.png/510px-FeedValueFieldInterface%601Component.png)](https://wiki.resonite.com/File:FeedValueFieldInterface%601Component.png) **Feed Value Field Interface\`1** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedValueFieldInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system. This component allows for making a UI Template for changing a value.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedValueFieldInterface&oldid=97502](https://wiki.resonite.com/index.php?title=Component:FeedValueFieldInterface&oldid=97502)"
