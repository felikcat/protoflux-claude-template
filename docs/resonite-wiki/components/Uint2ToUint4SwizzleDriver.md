# Component:Uint2ToUint4SwizzleDriver

> Source: https://wiki.resonite.com/Component:Uint2ToUint4SwizzleDriver

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/4/4f/Uint2ToUint4SwizzleDriverComponent.png/510px-Uint2ToUint4SwizzleDriverComponent.png)](https://wiki.resonite.com/File:Uint2ToUint4SwizzleDriverComponent.png) **Uint 2To Uint 4Swizzle Driver** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Source` | _direct_ **[RelayRef\`1](https://wiki.resonite.com/Type:RelayRef%601 "Type:RelayRef`1") < [IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Uint2](https://wiki.resonite.com/Type:Uint2 "Type:Uint2") >>** | The field which to take values from it's components and drive `Target`'s components with them. |
| `Target` | _[field drive](https://wiki.resonite.com/Type:FieldDrive%601 "Type:FieldDrive`1")_ of **[Uint4](https://wiki.resonite.com/Type:Uint4 "Type:Uint4")** | The field which to drive the components of. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:Uint2ToUint4SwizzleDriver&oldid=91097](https://wiki.resonite.com/index.php?title=Component:Uint2ToUint4SwizzleDriver&oldid=91097)"
