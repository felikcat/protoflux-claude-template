...
> Source: https://wiki.resonite.com/Component:SpotLightTool

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/5/54/SpotLightToolComponent.png/510px-SpotLightToolComponent.png)](https://wiki.resonite.com/File:SpotLightToolComponent.png) **Spot Light Tool** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Material` | **[PBS\_Metallic](https://wiki.resonite.com/PBS_Metallic "PBS Metallic")** | The material for the default cone visual. |
| `Light` | **[Light](https://wiki.resonite.com/Component:Light "Component:Light")** | The light attached to this tool that turns on and off |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:SpotLightTool&oldid=95700](https://wiki.resonite.com/index.php?title=Component:SpotLightTool&oldid=95700)"
