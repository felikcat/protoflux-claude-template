# Component:FeedGridInterface

> Source: https://wiki.resonite.com/Component:FeedGridInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/5/52/FeedGridInterfaceComponent.png/510px-FeedGridInterfaceComponent.png)](https://wiki.resonite.com/File:FeedGridInterfaceComponent.png) **Feed Grid Interface** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedGridInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedGridInterface&oldid=97492](https://wiki.resonite.com/index.php?title=Component:FeedGridInterface&oldid=97492)"
