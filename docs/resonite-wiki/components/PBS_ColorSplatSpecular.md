...
> Source: https://wiki.resonite.com/Component:PBS_ColorSplatSpecular

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:PBS_ColorSplatSpecular&diff=105843) which are not marked for translation.

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/b/b1/PBS_ColorSplatSpecularComponent.png/510px-PBS_ColorSplatSpecularComponent.png)](https://wiki.resonite.com/File:PBS_ColorSplatSpecularComponent.png) **PBS Color Splat Specular** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `PackedHeightMap` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | See [#Packed Textures Channel Mappings](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#Packed_Textures_Channel_Mappings). |
...
| `PackedEmissionMap` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | See [#Packed Textures Channel Mappings](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#Packed_Textures_Channel_Mappings). |
| `PackedNormalMap01` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | See [#Packed Textures Channel Mappings](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#Packed_Textures_Channel_Mappings). |
| `PackedNormalMap23` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | See [#Packed Textures Channel Mappings](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#Packed_Textures_Channel_Mappings). |
...
| `OffsetFactor` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer, based on the polygon's slope relative to the camera (i.e. polygons parallel to the camera will not be affected by this).[\[1\]](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#cite_note-Material_OffsetFactor/Units_Desc-1) |
| `OffsetUnits` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer (regardless of the polygon's slope relative to the camera), in units equal to the smallest possible difference for the rendering device being used.[\[1\]](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#cite_note-Material_OffsetFactor/Units_Desc-1) |
...
| `SpecularColor2` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The color for the Specular 2 if `SpecularMap2` is null. |
| `SpecularColor3` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The color for the Specular 3 if `SpecularMap3` is null. |
...
| `SpecularMap2` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | The Specular map plus color for Specular 2. |
| `SpecularMap3` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | The Specular map plus color for Specular 3. |
...
- [Component:PBS\_ColorSplatMetallic](https://wiki.resonite.com/Component:PBS_ColorSplatMetallic "Component:PBS ColorSplatMetallic")
...
1. ↑ [Jump up to: 1.0](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#cite_ref-Material_OffsetFactor/Units_Desc_1-0)[1.1](https://wiki.resonite.com/Component:PBS_ColorSplatSpecular#cite_ref-Material_OffsetFactor/Units_Desc_1-1)[https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html](https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html)

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:PBS\_ColorSplatSpecular&oldid=105843](https://wiki.resonite.com/index.php?title=Component:PBS_ColorSplatSpecular&oldid=105843)"
