# Component:PBS DisplaceSpecular

> Source: https://wiki.resonite.com/Component:PBS_DisplaceSpecular

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/5/5e/PBS_DisplaceSpecularComponent.png/510px-PBS_DisplaceSpecularComponent.png)](https://wiki.resonite.com/File:PBS_DisplaceSpecularComponent.png) **PBS Displace Specular** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **PBS\_DisplaceSpecular** component can displace the vertices of a mesh _in the direction of the vertex's normal_ via the VertexDisplaceMap settings and the WorldSpaceVertexOffsetMap.
...
| `VertexDisplaceMap` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | See [VertexDisplaceMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#VertexDisplaceMap). |
| `VertexDisplaceMagnitude` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | See [VertexDisplaceMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#VertexDisplaceMap). |
| `VertexDisplaceBias` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | See [VertexDisplaceMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#VertexDisplaceMap). |
| `VertexDisplaceMapScale` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | See [VertexDisplaceMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#VertexDisplaceMap). |
| `VertexDisplaceMapOffset` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | See [VertexDisplaceMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#VertexDisplaceMap). |
...
| `WorldspaceVertexOffsetMap` | **[ITexture2D](https://wiki.resonite.com/Type:ITexture2D "Type:ITexture2D")** | See [WorldSpaceVertexOffsetMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#WorldSpaceVertexOffsetMap). |
| `WorldspaceOffsetMagnitude` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | See [WorldSpaceVertexOffsetMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#WorldSpaceVertexOffsetMap). |
| `WorldspaceVertexOffsetMapScale` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | See [WorldSpaceVertexOffsetMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#WorldSpaceVertexOffsetMap). |
| `WorldspaceVertexOffsetMapOffset` | **[Float2](https://wiki.resonite.com/Type:Float2 "Type:Float2")** | See [WorldSpaceVertexOffsetMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#WorldSpaceVertexOffsetMap). |
| `WorldspaceOffsetPerVertex` | **[Bool](https://wiki.resonite.com/Type:Bool "Type:Bool")** | See [WorldSpaceVertexOffsetMap](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#WorldSpaceVertexOffsetMap). |
...
| `OffsetFactor` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer, based on the polygon's slope relative to the camera (i.e. polygons parallel to the camera will not be affected by this).[\[1\]](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#cite_note-Material_OffsetFactor/Units_Desc-1) |
| `OffsetUnits` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer (regardless of the polygon's slope relative to the camera), in units equal to the smallest possible difference for the rendering device being used.[\[1\]](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#cite_note-Material_OffsetFactor/Units_Desc-1) |
...
The PBS Displace Specular shader can displace the vertices of a mesh _in the direction of the vertex's normal_ via the VertexDisplaceMap settings and the WorldSpaceVertexOffsetMap.
...
Froox shows how the displace maps affect how the leaves in palm trees are affected. Note that he is using a constantly bouncing LERP from 0 to 1 to simulate the effect of wind.

![](https://i.ytimg.com/vi/VNQr_k0H0MY/hqdefault.jpg)

[2021 06 23 02 02 50 - PBS Displace](https://www.youtube-nocookie.com/embed/VNQr_k0H0MY?autoplay=1)
...
1. ↑ [Jump up to: 1.0](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#cite_ref-Material_OffsetFactor/Units_Desc_1-0)[1.1](https://wiki.resonite.com/Component:PBS_DisplaceSpecular#cite_ref-Material_OffsetFactor/Units_Desc_1-1)[https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html](https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html)

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:PBS\_DisplaceSpecular&oldid=113110](https://wiki.resonite.com/index.php?title=Component:PBS_DisplaceSpecular&oldid=113110)"
