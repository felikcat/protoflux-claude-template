# Component:RibbonFollowerWidthConstantInitializer

> Source: https://wiki.resonite.com/Component:RibbonFollowerWidthConstantInitializer

Collapse **Component image**

[File:RibbonFollowerWidthConstantInitializerComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=RibbonFollowerWidthConstantInitializerComponent.png "File:RibbonFollowerWidthConstantInitializerComponent.png") **Ribbon Follower Width Constant Initializer** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Value` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | The starting width all ribbon followers in the particle system should have. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:RibbonFollowerWidthConstantInitializer&oldid=96062](https://wiki.resonite.com/index.php?title=Component:RibbonFollowerWidthConstantInitializer&oldid=96062)"
