...
> Source: https://wiki.resonite.com/Component:TrailColorRangeInitializer

Collapse **Component image**

[File:TrailColorRangeInitializerComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=TrailColorRangeInitializerComponent.png "File:TrailColorRangeInitializerComponent.png") **Trail Color Range Initializer** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `MinValue` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The minimum color a Trail can be born with. |
| `MaxValue` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The maximum color a Trail can be born with. |
...
- [Component:ParticleTrailsModule](https://wiki.resonite.com/Component:ParticleTrailsModule "Component:ParticleTrailsModule")
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:TrailColorRangeInitializer&oldid=96055](https://wiki.resonite.com/index.php?title=Component:TrailColorRangeInitializer&oldid=96055)"
