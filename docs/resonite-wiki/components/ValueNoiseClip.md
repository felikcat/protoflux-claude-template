...
> Source: https://wiki.resonite.com/Component:ValueNoiseClip

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:ValueNoiseClip&diff=98113) which are not marked for translation.

_This article or section is a stub. You can help the Resonite wiki by expanding it._

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/b/bf/ValueNoiseClipComponent.png/510px-ValueNoiseClipComponent.png)](https://wiki.resonite.com/File:ValueNoiseClipComponent.png) **Value Noise Clip** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Duration` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How long the clip is. |
| `Seed` | **[Int](https://wiki.resonite.com/Type:Int "Type:Int")** | The seed for the random audio noise. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:ValueNoiseClip&oldid=98113](https://wiki.resonite.com/index.php?title=Component:ValueNoiseClip&oldid=98113)"
