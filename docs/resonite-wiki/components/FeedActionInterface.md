# Component:FeedActionInterface

> Source: https://wiki.resonite.com/Component:FeedActionInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/5/5f/FeedActionInterfaceComponent.png/510px-FeedActionInterfaceComponent.png)](https://wiki.resonite.com/File:FeedActionInterfaceComponent.png) **Feed Action Interface** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedActionInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system.
...
| `Action` | **[SyncDelegate\`1](https://wiki.resonite.com/Type:SyncDelegate%601 "Type:SyncDelegate`1") < [Action](https://wiki.resonite.com/Type:Action "Type:Action") >** | The field to fill with the Action Sync delegate when this is set up as a template via a data feed. |
| `Highlight` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Bool](https://wiki.resonite.com/Type:Bool "Type:Bool") >** | The bool to toggle when this item is highlighted. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedActionInterface&oldid=97488](https://wiki.resonite.com/index.php?title=Component:FeedActionInterface&oldid=97488)"
