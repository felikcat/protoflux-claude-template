...
> Source: https://wiki.resonite.com/Component:AudioWaveformTexture

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:AudioWaveformTexture&diff=97862) which are not marked for translation.

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/3/31/AudioWaveformTextureComponent.png/510px-AudioWaveformTextureComponent.png)](https://wiki.resonite.com/File:AudioWaveformTextureComponent.png) **Audio Waveform Texture** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **AudioWaveformTexture** component is used to generate a texture of a line with a visual representation of the volume and pitch of an audio over it's duration. For use with a [material](https://wiki.resonite.com/Material "Material").
...
| `Clip` | **[AudioClip](https://wiki.resonite.com/Type:AudioClip "Type:AudioClip")** | The audio clip to pull data from for generating the wave form. |
| `BackgroundColor` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The color behind the waveform. |
| `ForegroundColor` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The color of the waveform itself. |
...
Insert into a [material](https://wiki.resonite.com/Material "Material") to view what the texture looks like.
...
- [Audio Player](https://wiki.resonite.com/Audio_Player "Audio Player") uses this for it's visuals.

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:AudioWaveformTexture&oldid=97862](https://wiki.resonite.com/index.php?title=Component:AudioWaveformTexture&oldid=97862)"
