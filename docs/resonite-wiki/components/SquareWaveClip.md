...
> Source: https://wiki.resonite.com/Component:SquareWaveClip

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:SquareWaveClip&diff=98075) which are not marked for translation.

_This article or section is a stub. You can help the Resonite wiki by expanding it._

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/1/1d/SquareWaveClipComponent.png/510px-SquareWaveClipComponent.png)](https://wiki.resonite.com/File:SquareWaveClipComponent.png) **Square Wave Clip** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **SquareWaveClip** component makes a kind of buzzing noise that can be given a pitch and a loudness.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:SquareWaveClip&oldid=98075](https://wiki.resonite.com/index.php?title=Component:SquareWaveClip&oldid=98075)"
