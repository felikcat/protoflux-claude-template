# Component:InteractiveCameraObjectExcludeTool

> Source: https://wiki.resonite.com/Component:InteractiveCameraObjectExcludeTool

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/8/8e/InteractiveCameraObjectExcludeToolComponent.png/510px-InteractiveCameraObjectExcludeToolComponent.png)](https://wiki.resonite.com/File:InteractiveCameraObjectExcludeToolComponent.png) **Interactive Camera Object Exclude Tool** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **InteractiveCameraObjectExludeTool** component can add or remove objects from the exclude render list of the user's currently active [InteractiveCamera](https://wiki.resonite.com/Component:InteractiveCamera "Component:InteractiveCamera").
...
| `ApplyToObjectRoot` | **[Bool](https://wiki.resonite.com/Type:Bool "Type:Bool")** | Whether to look for the object root of a hit collider before adding it to the exlude list. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:InteractiveCameraObjectExcludeTool&oldid=94800](https://wiki.resonite.com/index.php?title=Component:InteractiveCameraObjectExcludeTool&oldid=94800)"
