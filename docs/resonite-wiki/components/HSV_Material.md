# Component:HSV Material

> Source: https://wiki.resonite.com/Component:HSV_Material

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:HSV_Material&diff=105831) which are not marked for translation.

_This article or section is a stub. You can help the Resonite wiki by expanding it._

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/8/8b/HSV_MaterialComponent.png/510px-HSV_MaterialComponent.png)](https://wiki.resonite.com/File:HSV_MaterialComponent.png) **HSV Material** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **HSV\_Material** is used to change the hue, staturation, and colors of objects being rendered behind it.
...
| `HSV_Offset` | **[Float3](https://wiki.resonite.com/Type:Float3 "Type:Float3")** | How much to add to the hue, saturation, and value of colors behind the material |
| `HSV_Multiply` | **[Float3](https://wiki.resonite.com/Type:Float3 "Type:Float3")** | How much to multiply the hue, saturation, and value of colors behind the material |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:HSV\_Material&oldid=105831](https://wiki.resonite.com/index.php?title=Component:HSV_Material&oldid=105831)"
