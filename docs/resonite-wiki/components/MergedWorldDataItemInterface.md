...
> Source: https://wiki.resonite.com/Component:MergedWorldDataItemInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/1/16/MergedWorldDataItemInterfaceComponent.png/510px-MergedWorldDataItemInterfaceComponent.png)](https://wiki.resonite.com/File:MergedWorldDataItemInterfaceComponent.png) **Merged World Data Item Interface** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **MergedWorldDataItemInterface** component is used to display world details from a [Component:WorldsDataFeed](https://wiki.resonite.com/Component:WorldsDataFeed "Component:WorldsDataFeed").
...
| `IsMerged` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Bool](https://wiki.resonite.com/Type:Bool "Type:Bool") >** | The field to drive with whether or not the source data feed item was merged. |
| `SessionCount` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Int](https://wiki.resonite.com/Type:Int "Type:Int") >** | The field to drive with the amount of sessions in this set of worlds. |
| `WorldCount` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Int](https://wiki.resonite.com/Type:Int "Type:Int") >** | The field to drive with the amount of Merged worlds into this item. |
| `MainName` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [String](https://wiki.resonite.com/Type:String "Type:String") >** | The field to drive with the main world name of this Merged item. |
| `MainThumbnail` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Uri](https://wiki.resonite.com/Type:Uri "Type:Uri") >** | The field to drive with the main world's thumbnail of this Merged item. |
| `WorldOrSessionId` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [String](https://wiki.resonite.com/Type:String "Type:String") >** | The field to drive with the main world or session ID of this Merged item. |
| `TotalAggregateActiveUsers` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Int](https://wiki.resonite.com/Type:Int "Type:Int") >** | The field to drive with the total active users of all the worlds Merged into this item. |
| `TotalAggregateContacts` | **[IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Int](https://wiki.resonite.com/Type:Int "Type:Int") >** | The field to drive with the total users that are contacts in all the worlds Merged into this item. |
| `Sessions` | _direct_ **[FeedSubTemplate\`2](https://wiki.resonite.com/Type:FeedSubTemplate%602 "Type:FeedSubTemplate`2") < [DataFeedEntity\`1](https://wiki.resonite.com/Type:DataFeedEntity%601 "Type:DataFeedEntity`1") < [SessionInfo](https://wiki.resonite.com/Type:SessionInfo "Type:SessionInfo") >, [SessionInfoItemInterface](https://wiki.resonite.com/Component:SessionInfoItemInterface "Component:SessionInfoItemInterface") >** | The list of item templates to instantiate with session info from this merged item. |
| `Worlds` | _direct_ **[FeedSubTemplate\`2](https://wiki.resonite.com/Type:FeedSubTemplate%602 "Type:FeedSubTemplate`2") < [DataFeedEntity\`1](https://wiki.resonite.com/Type:DataFeedEntity%601 "Type:DataFeedEntity`1") < [World](https://wiki.resonite.com/Type:World "Type:World") >, [WorldItemInterface](https://wiki.resonite.com/Component:WorldItemInterface "Component:WorldItemInterface") >** | The list of item templates to instantiate with the world data of this merged item. |
...
Used in data feed Template generating systems. See [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds").
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:MergedWorldDataItemInterface&oldid=97617](https://wiki.resonite.com/index.php?title=Component:MergedWorldDataItemInterface&oldid=97617)"
