...
> Source: https://wiki.resonite.com/Component:UI_UnlitMaterial

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:UI_UnlitMaterial&diff=105877) which are not marked for translation.

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/d/d4/UI_UnlitMaterialComponent.png/510px-UI_UnlitMaterialComponent.png)](https://wiki.resonite.com/File:UI_UnlitMaterialComponent.png) **UI Unlit Material** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **UI\_UnlitMaterial** component is used to show [UIX](https://wiki.resonite.com/UIX "UIX"). This material works best when rendered on a base, which the sample UIX made through the dev create new menu has by default.
...
| `AlphaClip` | **[Bool](https://wiki.resonite.com/Type:Bool "Type:Bool")** | Any alpha value below this amount is not rendered for any given pixel when cutout is enabled. |
| `TextureMode` | **[UnlitTextureMode](https://wiki.resonite.com/Type:UnlitTextureMode "Type:UnlitTextureMode")** | How to use `Texture`. |
...
| `OffsetFactor` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer, based on the polygon's slope relative to the camera (i.e. polygons parallel to the camera will not be affected by this).[\[1\]](https://wiki.resonite.com/Component:UI_UnlitMaterial#cite_note-Material_OffsetFactor/Units_Desc-1) |
| `OffsetUnits` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | How much this material should be pushed forwards or backwards on the depth buffer (regardless of the polygon's slope relative to the camera), in units equal to the smallest possible difference for the rendering device being used.[\[1\]](https://wiki.resonite.com/Component:UI_UnlitMaterial#cite_note-Material_OffsetFactor/Units_Desc-1) |
...
1. ↑ [Jump up to: 1.0](https://wiki.resonite.com/Component:UI_UnlitMaterial#cite_ref-Material_OffsetFactor/Units_Desc_1-0)[1.1](https://wiki.resonite.com/Component:UI_UnlitMaterial#cite_ref-Material_OffsetFactor/Units_Desc_1-1)[https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html](https://docs.unity3d.com/6000.2/Documentation/Manual/SL-Offset.html)

Retrieved from " [https://wiki.resonite.com/index.php?title=Component:UI\_UnlitMaterial&oldid=105877](https://wiki.resonite.com/index.php?title=Component:UI_UnlitMaterial&oldid=105877)"
