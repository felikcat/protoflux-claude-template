# Component:Int2ToInt4SwizzleDriver

> Source: https://wiki.resonite.com/Component:Int2ToInt4SwizzleDriver

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/4/49/Int2ToInt4SwizzleDriverComponent.png/510px-Int2ToInt4SwizzleDriverComponent.png)](https://wiki.resonite.com/File:Int2ToInt4SwizzleDriverComponent.png) **Int 2To Int 4Swizzle Driver** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Source` | _direct_ **[RelayRef\`1](https://wiki.resonite.com/Type:RelayRef%601 "Type:RelayRef`1") < [IField\`1](https://wiki.resonite.com/Type:IField%601 "Type:IField`1") < [Int2](https://wiki.resonite.com/Type:Int2 "Type:Int2") >>** | The field which to take values from it's components and drive `Target`'s components with them. |
| `Target` | _[field drive](https://wiki.resonite.com/Type:FieldDrive%601 "Type:FieldDrive`1")_ of **[Int4](https://wiki.resonite.com/Type:Int4 "Type:Int4")** | The field which to drive the components of. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:Int2ToInt4SwizzleDriver&oldid=91088](https://wiki.resonite.com/index.php?title=Component:Int2ToInt4SwizzleDriver&oldid=91088)"
