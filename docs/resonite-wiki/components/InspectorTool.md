...
> Source: https://wiki.resonite.com/Component:InspectorTool

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/b/b1/InspectorToolComponent.png/510px-InspectorToolComponent.png)](https://wiki.resonite.com/File:InspectorToolComponent.png) **Inspector Tool** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

Opens an inspector when hitting [primary](https://wiki.resonite.com/Controls "Controls").
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:InspectorTool&oldid=91391](https://wiki.resonite.com/index.php?title=Component:InspectorTool&oldid=91391)"
