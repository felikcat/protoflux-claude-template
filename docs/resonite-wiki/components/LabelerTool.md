# Component:LabelerTool

> Source: https://wiki.resonite.com/Component:LabelerTool

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/f/f8/LabelerToolComponent.png/510px-LabelerToolComponent.png)](https://wiki.resonite.com/File:LabelerToolComponent.png) **Labeler Tool** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

See [Tools](https://wiki.resonite.com/Tools "Tools") for where to get this tool and what it does.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:LabelerTool&oldid=91393](https://wiki.resonite.com/index.php?title=Component:LabelerTool&oldid=91393)"
