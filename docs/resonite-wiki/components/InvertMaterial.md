# Component:InvertMaterial

> Source: https://wiki.resonite.com/Component:InvertMaterial

This page contains [changes](https://wiki.resonite.com/index.php?title=Component:InvertMaterial&diff=105832) which are not marked for translation.

_This article or section is a stub. You can help the Resonite wiki by expanding it._

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/7/77/InvertMaterialComponent.png/510px-InvertMaterialComponent.png)](https://wiki.resonite.com/File:InvertMaterialComponent.png) **Invert Material** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The invert material inverts the colors of things behind it
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:InvertMaterial&oldid=105832](https://wiki.resonite.com/index.php?title=Component:InvertMaterial&oldid=105832)"
