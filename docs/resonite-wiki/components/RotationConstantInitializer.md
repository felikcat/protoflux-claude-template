# Component:RotationConstantInitializer

> Source: https://wiki.resonite.com/Component:RotationConstantInitializer

Collapse **Component image**

[File:RotationConstantInitializerComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=RotationConstantInitializerComponent.png "File:RotationConstantInitializerComponent.png") **Rotation Constant Initializer** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Value` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | The starting rotation to give particles along their orientation axis. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:RotationConstantInitializer&oldid=96073](https://wiki.resonite.com/index.php?title=Component:RotationConstantInitializer&oldid=96073)"
