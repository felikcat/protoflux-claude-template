...
> Source: https://wiki.resonite.com/Component:Bool3ToBool4SwizzleDriver

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/c/c4/Bool3ToBool4SwizzleDriverComponent.png/510px-Bool3ToBool4SwizzleDriverComponent.png)](https://wiki.resonite.com/File:Bool3ToBool4SwizzleDriverComponent.png) **Bool 3To Bool 4Swizzle Driver** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Target` | _[field drive](https://wiki.resonite.com/Type:FieldDrive%601 "Type:FieldDrive`1")_ of **[Bool4](https://wiki.resonite.com/Type:Bool4 "Type:Bool4")** | The field which to drive the components of. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:Bool3ToBool4SwizzleDriver&oldid=91126](https://wiki.resonite.com/index.php?title=Component:Bool3ToBool4SwizzleDriver&oldid=91126)"
