# Component:WigglerApplier

> Source: https://wiki.resonite.com/Component:WigglerApplier

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/4/40/WigglerApplierComponent.png/510px-WigglerApplierComponent.png)](https://wiki.resonite.com/File:WigglerApplierComponent.png) **Wiggler Applier** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

Applies a [Wiggler Component](https://wiki.resonite.com/Component:Wiggler "Component:Wiggler") to a slot to make it rotate randomly.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:WigglerApplier&oldid=91408](https://wiki.resonite.com/index.php?title=Component:WigglerApplier&oldid=91408)"
