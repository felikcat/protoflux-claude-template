...
> Source: https://wiki.resonite.com/Component:FeedEntityInterface

Collapse **Component image**

[![](https://wiki.resonite.com/images/thumb/6/68/FeedEntityInterface%601Component.png/510px-FeedEntityInterface%601Component.png)](https://wiki.resonite.com/File:FeedEntityInterface%601Component.png) **Feed Entity Interface\`1** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **FeedEntityInterface** component is used as a template type item in data feed mappers in the [Data Feeds](https://wiki.resonite.com/Data_Feeds "Data Feeds") system. This is most commonly used with the [WorldUsersFeed](https://wiki.resonite.com/Component:WorldUsersFeed "Component:WorldUsersFeed") feed to template user items from the feed.
...
| `Reference` | **[SyncRef\`1](https://wiki.resonite.com/Type:SyncRef%601 "Type:SyncRef`1") <E>** | The field to fill with the reference value from the source data feed. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:FeedEntityInterface&oldid=97491](https://wiki.resonite.com/index.php?title=Component:FeedEntityInterface&oldid=97491)"
