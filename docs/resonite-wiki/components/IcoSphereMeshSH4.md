# Component:IcoSphereMeshSH4

> Source: https://wiki.resonite.com/Component:IcoSphereMeshSH4

Collapse **Component image**

[File:IcoSphereMeshSH4Component.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=IcoSphereMeshSH4Component.png "File:IcoSphereMeshSH4Component.png") **Ico Sphere Mesh SH4** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")
...
| `Colors` | **[SphericalHarmonicsL4\`1](https://wiki.resonite.com/Type:SphericalHarmonicsL4%601 "Type:SphericalHarmonicsL4`1") < [ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX") >** | The spherical harmonic colors to use. |
| `RadiusMultiplier` | **[SphericalHarmonicsL4\`1](https://wiki.resonite.com/Type:SphericalHarmonicsL4%601 "Type:SphericalHarmonicsL4`1") < [Float](https://wiki.resonite.com/Type:Float "Type:Float") >** | The spherical harmonics to use to influence the mesh radius at different spots. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:IcoSphereMeshSH4&oldid=98457](https://wiki.resonite.com/index.php?title=Component:IcoSphereMeshSH4&oldid=98457)"
