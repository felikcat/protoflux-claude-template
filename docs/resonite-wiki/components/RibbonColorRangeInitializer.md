# Component:RibbonColorRangeInitializer

> Source: https://wiki.resonite.com/Component:RibbonColorRangeInitializer

Collapse **Component image**

[File:RibbonColorRangeInitializerComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=RibbonColorRangeInitializerComponent.png "File:RibbonColorRangeInitializerComponent.png") **Ribbon Color Range Initializer** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **RibbonColorRangeInitializer** component gives ribbons in a particle system a random color in a range upon start.
...
| `MinValue` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The minimum color a ribbon can have. |
| `MaxValue` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The maximum color a ribbon can have. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:RibbonColorRangeInitializer&oldid=96063](https://wiki.resonite.com/index.php?title=Component:RibbonColorRangeInitializer&oldid=96063)"
