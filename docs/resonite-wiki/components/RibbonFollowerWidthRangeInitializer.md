# Component:RibbonFollowerWidthRangeInitializer

> Source: https://wiki.resonite.com/Component:RibbonFollowerWidthRangeInitializer

Collapse **Component image**

[File:RibbonFollowerWidthRangeInitializerComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=RibbonFollowerWidthRangeInitializerComponent.png "File:RibbonFollowerWidthRangeInitializerComponent.png") **Ribbon Follower Width Range Initializer** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **RibbonFollowerWidthRangeInitializer** component gives ribbon followers in a particle system a random width in a range.
...
| `MinValue` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | The minimum width ribbons can have. |
| `MaxValue` | **[Float](https://wiki.resonite.com/Type:Float "Type:Float")** | The maximum width ribbons<br>can have. |
...
- [Component:ParticleRibbonsModule](https://wiki.resonite.com/Component:ParticleRibbonsModule "Component:ParticleRibbonsModule")
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:RibbonFollowerWidthRangeInitializer&oldid=96061](https://wiki.resonite.com/index.php?title=Component:RibbonFollowerWidthRangeInitializer&oldid=96061)"
