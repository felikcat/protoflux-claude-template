# Component:RibbonColorConstantInitializer

> Source: https://wiki.resonite.com/Component:RibbonColorConstantInitializer

Collapse **Component image**

[File:RibbonColorConstantInitializerComponent.png](https://wiki.resonite.com/index.php?title=Special:Upload&wpDestFile=RibbonColorConstantInitializerComponent.png "File:RibbonColorConstantInitializerComponent.png") **Ribbon Color Constant Initializer** component as seen in the [Scene Inspector](https://wiki.resonite.com/Scene_Inspector "Scene Inspector")

The **RibbonColorConstantInitializer** gives all ribbons a color of `Value` upon start in a particle system.
...
| `Value` | **[ColorX](https://wiki.resonite.com/Type:ColorX "Type:ColorX")** | The color to give all ribbons. |
...
Retrieved from " [https://wiki.resonite.com/index.php?title=Component:RibbonColorConstantInitializer&oldid=96065](https://wiki.resonite.com/index.php?title=Component:RibbonColorConstantInitializer&oldid=96065)"
