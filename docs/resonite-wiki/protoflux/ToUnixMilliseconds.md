...
> Source: https://wiki.resonite.com/ProtoFlux:ToUnixMilliseconds
...
The `To Unix Milliseconds` node takes in a [DateTime](https://wiki.resonite.com/Type:DateTime "Type:DateTime") and returns with the amount of milliseconds elapsed from that DateTime since January 1st, 1970.
...
Retrieved from " [https://wiki.resonite.com/index.php?title=ProtoFlux:ToUnixMilliseconds&oldid=110849](https://wiki.resonite.com/index.php?title=ProtoFlux:ToUnixMilliseconds&oldid=110849)"
