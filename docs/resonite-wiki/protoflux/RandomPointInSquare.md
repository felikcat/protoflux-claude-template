# ProtoFlux:RandomPointInSquare

> Source: https://wiki.resonite.com/ProtoFlux:RandomPointInSquare
...
The **Random Point In Square** node returns a random [float2](https://wiki.resonite.com/Type:Float2 "Type:Float2") value of a point within the bounds of a [unit square](https://en.wikipedia.org/wiki/Unit_square) centered at `[0; 0]`.
...
A random point within the unit square centered at `[0; 0]`.

Retrieved from " [https://wiki.resonite.com/index.php?title=ProtoFlux:RandomPointInSquare&oldid=110515](https://wiki.resonite.com/index.php?title=ProtoFlux:RandomPointInSquare&oldid=110515)"
