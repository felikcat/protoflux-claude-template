# ProtoFlux:RandomPointOnSphere

> Source: https://wiki.resonite.com/ProtoFlux:RandomPointOnSphere
...
The **Random Point On Sphere** node returns a random [float3](https://wiki.resonite.com/Type:Float3 "Type:Float3") value of a point on the shell of a [unit sphere](https://en.wikipedia.org/wiki/Unit_sphere).
...
Retrieved from " [https://wiki.resonite.com/index.php?title=ProtoFlux:RandomPointOnSphere&oldid=110523](https://wiki.resonite.com/index.php?title=ProtoFlux:RandomPointOnSphere&oldid=110523)"
